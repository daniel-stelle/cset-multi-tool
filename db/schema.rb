...
ActiveRecord::Schema.define(version: 20160301044602) do
  ...
  add_index 'relationships', ['supervisor_id'],
            name: 'index_relationships_on_supervisor_id'
  add_index 'relationships', %w('worker_id', 'supervisor_id'), 
            name: 'index_relationships_on_worker_id_and_supervisor_id',
            unique: true
  add_index 'relationships', ['worker_id'],
            name: 'index_relationships_on_worker_id'
  ...
  add_index 'timesheet_rows', ['timesheet_id'],
            name: 'index_timesheet_rows_on_timesheet_id'
